...
function AppContent() {
  ...
  // Use the detailed incident data if available, otherwise fall back to list data
      ...
      <main className="flex-1 overflow-hidden">
        {currentView === 'dashboard' ? (
          ...
          <div className="flex-1 overflow-y-auto p-2 space-y-2">
            {incidents?.sort((a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime()).map((inc: Incident) => (
              <div 
                key={inc.id}
